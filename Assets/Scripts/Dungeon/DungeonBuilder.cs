...
public class DungeonBuilder : SingletonMonobehaviour<DungeonBuilder>
{
    ...
    private bool AttemptToBuildRandomDungeon(RoomNodeGraphSO roomNodeGraph)
    {
        ...
        else
        {
            ...
            return false;  // dungeon sie nie zbudowa³
        }
    ...
    private bool CanPlaceRoomWithNoOverlaps(RoomNodeSO roomNode, Room parentRoom)
    {
        ...
        while (roomOverlaps)
        {
            ...
            {
                return false; // pokoje sie nak³adaj¹
            }
        ...
        return true;  // pokoje sie nie nakladaja
    ...
    private Room CreateRoomFromRoomTemplate(RoomTemplateSO roomTemplate, RoomNodeSO roomNode)
    {
        ...
        if (roomNode.parentRoomNodeIDList.Count == 0) // Wejscie
        {
            ...
            // ustawienei wejscia w game menagerze
   ...
   //oblicza pozycjê pokoju 
            Vector3 roomPosition = new Vector3(room.lowerBounds.x - room.templateLowerBounds.x, room.lowerBounds.y - room.templateLowerBounds.y, 0f);

            // inicjacja pokoi
            GameObject roomGameobject = Instantiate(room.prefab, roomPosition, Quaternion.identity, transform);

            //  pobiera prefaby do pokoju
            ...
            // zapisuje referencje do prefabu
