...
public class PoolManager : SingletonMonobehaviour<PoolManager>
{
    ...
    private void CreatePool(GameObject prefab, int poolSize, string componentType)
    {
        ...
        string prefabName = prefab.name; // bierze prefab name

        GameObject parentGameObject = new GameObject(prefabName + "Anchor"); // objects to tworzy parent gaobject do child objektu
